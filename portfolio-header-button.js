 ...
 * 
 * @demo index.html
 * @element portfolio-header-button
 */
export class PortfolioHeaderButton extends DDDSuper(I18NMixin(LitElement)) {

  static get tag() {
    return "portfolio-header-button";
  }
...
globalThis.customElements.define(PortfolioHeaderButton.tag, PortfolioHeaderButton);